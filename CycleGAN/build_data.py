...
tf.flags.DEFINE_string('X_input_dir', 'data/summer2winter_road_256/trainA',
                       'X input directory, default: data/summer2winter_road_256/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/summer2winter_road_256/trainB',
                       'Y input directory, default: data/summer2winter_road_256/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/summer.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/summer.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/winter.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/winter.tfrecords')
